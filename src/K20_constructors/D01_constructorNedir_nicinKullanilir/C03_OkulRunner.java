...
public class C03_OkulRunner {
    ...
    public static void main(String[] args) {
        ...
        // C02_Okul class'indan bir obje deklare edip deger atamasi yapmayalim ve objeyi kullanmaya calisalim
        ...
        /*
                obje deklare edilip, constructor calisirsa obje sorunsuz kullanilir (ogrenci1)
                obje deklare edilip, constructor calismazsa, obje olusturulmus olmaz,
                dolayisiyla objenin hic bir ozelligi KULLANILAMAZ
                obje deklare edilmeden, constructor calisirsa objenin bir ismi olmaz,
                SADECE olusturuldugu satirda kullanilabilir, sonraki satira gecildiginde obje cop olur
         */
    }
}